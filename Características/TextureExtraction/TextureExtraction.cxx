...
typedef itk::Statistics::ScalarImageToCooccurrenceMatrixFilter<UnsignedCharImageType>
...
typedef UnsignedCharImageType::OffsetType OffsetType;
typedef itk::RegionOfInterestImageFilter<UnsignedCharImageType,UnsignedCharImageType> roiType;
    

//calculate features for one offset
void calcTextureFeatureImage (OffsetType offset,
    UnsignedCharImageType::Pointer inputImage, UnsignedCharImageType::Pointer outInertia,
    UnsignedCharImageType::Pointer outCorrelation, UnsignedCharImageType::Pointer outEnergy)
{
    ...
    UnsignedCharImageType::RegionType window;
    UnsignedCharImageType::RegionType::SizeType size;
    size.Fill(2); 
    window.SetSize(size);
    UnsignedCharImageType::IndexType pi; //pixel index
...
int main(int argc, char*argv[])
{
  ...
  reader->Update();
  UnsignedCharImageType::Pointer image=reader->GetOutput();
  ...
  for ( unsigned int d = 0; d < centerIndex; d++ )
  {
      ...
      UnsignedCharImageType::Pointer inertia=UnsignedCharImageType::New();
      UnsignedCharImageType::Pointer correlation=UnsignedCharImageType::New();
      UnsignedCharImageType::Pointer energy=UnsignedCharImageType::New();
